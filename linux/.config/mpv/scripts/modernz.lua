...
local user_opts = {
    ...
    -- Colors and style
    osc_color = "#24273a",                 -- accent color of the OSC and title bar
    ...
    windowcontrols_max_hover = "#a6da95",  -- color of maximize window controls on hover
    windowcontrols_min_hover = "#eed49f",  -- color of minimize window controls on hover
    title_color = "#FFFFFF",               -- color of the title (above seekbar)
    cache_info_color = "#FFFFFF",          -- color of the cache information
    seekbarfg_color = "#b7bdf8",           -- color of the seekbar progress and handle
    seekbarbg_color = "#363a4f",           -- color of the remaining seekbar
    seekbar_cache_color = "#5b6078",       -- color of the cache ranges on the seekbar
    ...
    held_element_color = "#6e738d",        -- color of the element when held down (pressed)
    hover_effect_color = "#b7bdf8",        -- color of a hovered button when hover_effect includes "color"
    thumbnail_border_color = "#1e2030",    -- color of the border for thumbnails (with thumbfast)
