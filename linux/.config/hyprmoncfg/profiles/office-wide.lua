...
hl.workspace_rule({ workspace = "6", monitor = "desc:Xiaomi Corporation Mi Monitor 0000000000000" })
hl.workspace_rule({ workspace = "7", monitor = "desc:Xiaomi Corporation Mi Monitor 0000000000000" })
hl.workspace_rule({ workspace = "8", monitor = "desc:Xiaomi Corporation Mi Monitor 0000000000000" })
hl.workspace_rule({ workspace = "9", monitor = "desc:Xiaomi Corporation Mi Monitor 0000000000000" })
